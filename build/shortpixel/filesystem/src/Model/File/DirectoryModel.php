<?php
namespace ReThumbAdvanced\FileSystem\Model\File;
...
class DirectoryModel
{
  ...
  */
  public function __construct($path)
  {
   //   $path = wp_normalize_path($path);
	...
	{
		return new \ReThumbAdvanced\FileSystem\Controller\FileSystemController();
	}
  ...
  */
  private function fileIsRestricted($path)
  {
     ...
     $restricted = apply_filters('rta/file/basedir_check', $restricted);
  ...
  */
  public function getSubDirectories()
  {
    ...
    { // IsDot must go first here, or there is possiblity to run into openbasedir restrictions.
       ...
       {
				 if ('ReThumbAdvanced\Model\File\DirectoryOtherMediaModel' == get_called_class())
				 {
