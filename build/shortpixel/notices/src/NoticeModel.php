  ...
  */
  ...
  public function getForDisplay()
  {
    ...
    if ($this->hasDetails())
    {
      ...
      <label for="check-' . $id . '"  class="show-details"><span>' . __('See Details', 'regenerate-thumbnails-advanced/')   . '</span>
      </label>';

      $output .= "<div class='detail-content-wrapper'><p class='detail-content'>" . $this->parseDetails() . "</p></div>";
      $output .= '<label for="check-' . $id . '" class="hide-details"><span>' . __('Hide Details', 'regenerate-thumbnails-advanced/') . '</span></label>';
    ...
    if ($this->is_removable)
    {
			      $output .= '<button type="button" id="button-' . $id . '" class="notice-dismiss" data-dismiss="' . $this->suppress_period . '" ><span class="screen-reader-text">' . __('Dismiss this notice', 'regenerate-thumbnails-advanced/') . '</span></button>';
